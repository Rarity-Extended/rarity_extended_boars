...
import "../interfaces/ICodexSkills.sol";

contract rarity_skills {

    constructor(address rm_addr, address attr_addr, address codex_skills_addr){
        rm = IRarity(rm_addr);
        _attr = attributes(attr_addr);
        _codex_skills = codex_skills(codex_skills_addr);
    }

    IRarity public rm; 
    attributes public _attr; 
    codex_skills public _codex_skills;
